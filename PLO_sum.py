...
col1.metric(label="PLO 2", value=f"{plo_sums['PLO 2']:.2f}", delta="0", help="Total value for PLO 2", border=True)
col2.metric(label="PLO 3", value=f"{plo_sums['PLO 3']:.2f}", delta="0", help="Total value for PLO 3", border=True)
col3.metric(label="PLO 4", value=f"{plo_sums['PLO 4']:.2f}", delta="0", help="Total value for PLO 4", border=True)
col4.metric(label="PLO 5", value=f"{plo_sums['PLO 5']:.2f}", delta="0", help="Total value for PLO 5", border=True)
